 ...
 * Generated at: 2014-11-30 13:55:05 UTC
...
public final class gallery_005fupload_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/src/jsp/gallery/../../include/checkLogin.jsp", Long.valueOf(1417067248000L));
  }
...
if (layout.equals("contact")) {
      ...
      out.write("\n");
      out.write("\t\t\n");
      out.write("\t\t<form name=\"gallery_upload_form\" method=\"post\" enctype=\"multipart/form-data\" onkeydown=\"javascript:if(event.keyCode==13){upload();}\">\n");
      ...
      out.write("\t\t\t    \t<label>Gallery Upload</label>\n");
      out.write("\t\t\t    </div>\n");
      out.write("\t\t\t    \n");
      out.write("\t\t\t    <div class=\"clear h40\"></div>\n");
      out.write("\t\t\t    <div class=\"input_row\">\n");
      out.write("\t\t\t\t\t<span class=\"input_box\"> \n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"title\" id=\"title\" tabindex=\"7\" accesskey=\"L\"\tplaceholder=\"제목\" class=\"int\" maxlength=\"25\" value\tautocomplete=\"off\"/>\n");
      out.write("\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"clear h20\"></div>\n");
      out.write("\t\t\t\t<input type=\"file\" name=\"files[0]\" id=\"galleryFile\" onchange=\"uploadImg(this);\"/>\n");
      out.write("\t\t\t\t<div style=\"color: red; font-size: 12px;\">\n");
      out.write("\t\t\t\t\t※ 10MB 이하의 jpg, gif, png 파일만 업로드 가능합니다.\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t    <div class=\"clear h40\"></div>\n");
      out.write("\t\t\t    <div align=\"center\">\n");
      out.write("\t\t\t    \t\t<input type=\"button\" class=\"thoughtbot\" value=\"이미지 업로드\" onclick=\"upload()\"/>\n");
      out.write("\t\t\t    </div>\n");
      out.write("\t\t\t    \n");
      out.write("\t\t\t    \n");
      out.write("\t\t\t    <div class=\"clear h40\"></div>\n");
      ...
      out.write("\n");
      out.write("\t\t\tvar frm = document.gallery_upload_form;\n");
      out.write("\t\t\tfrm.action = \"./upload_ok.do\";\n");
      out.write("\n");
      out.write("\t\t\tvar title = document.getElementById(\"title\").value;\n");
      out.write("\t\t\tvar file = document.getElementById(\"galleryFile\").value;\n");
      out.write("\n");
      out.write("\t\t\tif (title == \"\") {\n");
      ...
      out.write("\t\t\t\talert(\"파일은 필수항목입니다.\");\n");
      out.write("\t\t\t\tfrm.file.focus();\n");
      out.write("\t\t\t\treturn;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\talert(\"이미지를 업로드하였습니다.\");\n");
      out.write("\t\t\tfrm.submit();\n");
      out.write("\t\t}\n");
      out.write("\n");
      out.write("\t\t//파일 업로드 이미지만 걸러내기\n");
      out.write("\t\tfunction uploadImg(fileObj) {\n");
      out.write("\t\t\tvar filePath = fileObj.value;\n");
      out.write("\t\t\tvar filesid = fileObj.id;\n");
      out.write("\t\t\tvar fileName = filePath.substring(filePath.lastIndexOf(\"\\\\\") + 1);\n");
      out.write("\t\t\tvar fileKind = fileName.split(\".\")[1];\n");
      out.write("\t\t\tif (fileKind != \"jpg\" && fileKind != \"gif\" && fileKind != \"png\") {\n");
      out.write("\t\t\t\talert(\"jpg, gif, png 확장자를 가진 이미지 파일만 올려주세요.\");\n");
      out.write("\t\t\t\tdocument.getElementById(filesid).value = \"\";\n");
      out.write("\t\t\t\tdocument.getElementById(filesid).select();\n");
