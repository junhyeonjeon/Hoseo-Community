 ...
 * Generated at: 2014-11-29 09:57:19 UTC
...
public final class search_005fid_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (layout.equals("contact")) {
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t\t<form name=\"search_form\" method=\"post\" action=\"id_ok.do\" onkeydown=\"javascript:if(event.keyCode==13){submit();}\">\n");
      ...
      out.write("\t\t\t\t\t\t<label style=\"font-size: 15px;\">아이디 찾기 - 가입 시 등록한 이메일을 입력해주세요.</label>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"clear h40\"></div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"input_row\">\n");
      out.write("\t\t\t\t\t\t<span class=\"input_box\">  \n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"email\" id=\"email\" tabindex=\"7\" accesskey=\"L\" placeholder=\"가입 시 등록한 이메일\" class=\"int\" value\tautocomplete=\"off\"/>\n");
      out.write("\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"clear h20\"></div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div align=\"center\">\n");
      out.write("\t\t\t\t\t\t<input type=\"button\" class=\"thoughtbot\" value=\"아이디 찾기\" onclick=\"submit()\"/>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</form>\n");
