		...
		<div id="templatemo_main">
			...
			<div id="rightview">
				...
				<div class="board_title">
					<h3 style="text-align: center;">받은 쪽지함</h3>
				</div>
				...
				<!-- 리스트 : 시작 -->
				<div
					style="display: block; overflow: hidden; width: 500; white-space: nowrap; text-overflow: ellipsis;">
					<table class="table_board" cellpadding="0" cellspacing="0"
						...
						<tbody>
							...
							%>
							<tr>
								<td align="center"><%=dto.getSendid()%></a></td>
				...
				<form name="frm1" method="post" >
					<input type='hidden' name='reuslt' value="<%=result%>" />
				</form>
				...
				<%
					if (list.size() == 0) {
				%>
				<div style="text-align: center; margin: 50px;">수신된 쪽지가 없습니다.</div>
				<%
					}
				%>
				<!-- 리스트 : 끝 -->
